  ...
  return (
    <Paper className="WhatsNew-card">
      ...
      <p className="WhatsNew-body">
        ...
        updates we've been quietly performing over the years, we now have a new
        major redesign, here's a list of the biggest changes:
      </p>
      <ul className="WhatsNew-list">
        ...
        <li>
          Set a favourite stop, see that stops info at the top of this dashboard
        </li>
        <li>Accessibility features, including contrast, low motion</li>
        ...
        <li>
          We're officially opening the doors for student developers/ideas, jump
          over to the settings and send us an email - it would look great on
          your CV
        </li>
      </ul>
    </Paper>
